package com.example.batch.readerFromMultiFileDemo;
...
@Configuration
public class ReaderFromMultiFileDemoConfig {
    private static final String applicationName = "ReaderFromMultiFile";
    @Autowired
    ...
    public ItemReader<Staff> reader1(String stepName) {
        return staffMultiFileService.getItemReader();
    }
